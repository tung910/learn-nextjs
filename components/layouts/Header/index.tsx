        ...
        <div className="container mx-auto flex flex-wrap items-center justify-between">
          ...
          <div className="hidden w-full md:block md:w-auto" id="mobile-menu">
            <ul className="mt-4 flex flex-col md:mt-0 md:flex-row md:space-x-8 md:text-sm md:font-medium">
              <li>
                <Link href="/">
                  <a className="block rounded bg-blue-700 py-2 pr-4 pl-3 text-white md:bg-transparent md:p-0 md:text-blue-700">
                    Home
                  </a>
                </Link>
              </li>
              ...
              <li>
                <a
                  href="#"
                  className=":dark:hover:bg-transparent block py-2 pr-4 pl-3 text-gray-700 hover:bg-gray-50 dark:text-gray-400 md:border-0 md:p-0 md:hover:bg-transparent md:hover:text-blue-700 md:dark:hover:text-white"
                >
                  Contact
                </a>
              </li>
